    ...
    <main className="min-h-[calc(100vh-4rem)] bg-base-100 px-4 py-10">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <NavLink to="/partners" className="btn btn-ghost btn-sm">Find More</NavLink>
        </div>
            ...
            <div className="overflow-x-auto">
              <table className="table table-zebra table-pin-rows">
                <thead className="bg-base-200 text-base-content/80">
                  <tr>
                    <th className="min-w-[240px]">Partner</th>
                    <th>Subject</th>
                    <th>Study Mode</th>
                    <th className="w-[160px] text-right pr-6">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {rows.map((r) => (
